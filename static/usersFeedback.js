...
const usersFeedback = (comment, rating) => {
    ...
    return p // I'm returning a <p> element so that it can be .appendChilded to #comment-HTML in 'index.js' (the 'child' has to be a node, either a HTML element or a textnode, that's why). So I can't just return a string if I want to appendChild it to something.
}
